...
def main():
    ...
    scaled_train = scaler.fit_transform(train_data[['temperature']])
    train_data['temperature'] = scaled_train

    scaled_test = scaler.transform(test_data[['temperature']])
    test_data['temperature'] = scaled_test
